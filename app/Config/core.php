 ...
 */
	Configure::write('Security.salt', 'DYhGjdskjfkls93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '768593834783209657453542496749683645');
